...
class OutputLayer(nn.Module):
    ...
    def forward(self, uQ, hp, q_s_lengths, p_s_lengths):
        vrQ = hp.sum(1)  # (batch_size, hidden_size * 2)
        rQ = self.attn1(uQ, vrQ, q_s_lengths)  # (batch_size, 2 * hidden_size)
